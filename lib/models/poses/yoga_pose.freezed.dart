...
mixin _$YogaPose {
 ...
 String get name; String get description; String? get sanskritName; String? get imageUrl; String get creatorUserId;// -1 for system/seed, user ID otherwise
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,originalId,name,description,sanskritName,imageUrl,creatorUserId,isPublished);

@override
String toString() {
  return 'YogaPose(id: $id, originalId: $originalId, name: $name, description: $description, sanskritName: $sanskritName, imageUrl: $imageUrl, creatorUserId: $creatorUserId, isPublished: $isPublished)';
}
...
@useResult
$Res call({
 String id, String? originalId, String name, String description, String? sanskritName, String? imageUrl, String creatorUserId, bool isPublished
});
...
/// Create a copy of YogaPose
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? originalId = freezed,Object? name = null,Object? description = null,Object? sanskritName = freezed,Object? imageUrl = freezed,Object? creatorUserId = null,Object? isPublished = null,}) {
...
class _YogaPose extends YogaPose {
  const _YogaPose({required this.id, this.originalId, required this.name, required this.description, this.sanskritName, this.imageUrl, this.creatorUserId = '-1', this.isPublished = false}): super._();
...
/// Create a copy of YogaPose
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? originalId = freezed,Object? name = null,Object? description = null,Object? sanskritName = freezed,Object? imageUrl = freezed,Object? creatorUserId = null,Object? isPublished = null,}) {
